...
- [x] 2.1 Reject the deterministic dated-archive destination collision before invoking OpenSpec.
- [x] 2.2 Verify active removal, archive creation and mandatory artifact preservation before reporting success.
- [x] 2.3 Preserve the existing readiness, loss-prevention and semantic post-archive gates.
