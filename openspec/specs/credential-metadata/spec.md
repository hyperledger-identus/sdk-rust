# Credential metadata specification

## Purpose

Define bounded, format-neutral credential metadata plus claim and schema shape
that adapters can project without implying wire parsing, cryptographic binding,
verification, trust, storage, or product policy.
