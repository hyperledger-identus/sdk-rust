...
| OWF [`askar`](https://github.com/openwallet-foundation/askar/tree/48a495920e2166771c6be1aca2fd057a8b0c8831) | `48a49592` | MIT OR Apache-2.0 | [Repository release v0.5.0](https://github.com/openwallet-foundation/askar/releases/tag/v0.5.0); crates.io `aries-askar` remains 0.4.6; MSRV 1.81 | Defaults bring database, FFI, logging, migration, native/unsafe, Tokio/SQLx and crypto; host/mobile evidence but no WASM | `spike` as optional native adapter under #162 |
