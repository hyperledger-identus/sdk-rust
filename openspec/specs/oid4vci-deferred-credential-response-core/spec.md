# oid4vci-deferred-credential-response-core Specification

## Purpose
TBD - created by archiving change add-oid4vci-deferred-credential-response. Update Purpose after archive.
## Requirements
