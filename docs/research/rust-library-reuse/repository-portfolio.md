...
| Affinidi [`affinidi-tdk-rs`](https://github.com/affinidi/affinidi-tdk-rs/tree/66120dd70d6919152923d00dad2eede8a7ec1ac3) OID4VC crates | `66120dd7` | Apache-2.0 | Published VCI 0.2.1, VP 0.1.3 and core 0.1.8; MSRV 1.95 | 107-package minimal combined probe; broad protocol models and Presentation Exchange-oriented VP surface | `oracle` |
| SIROS [`siros-dc-matcher`](https://github.com/sirosfoundation/siros-dc-matcher/tree/d4eeff53d24c9bf8e3fe50aecba2a554b2618961) | `d4eeff53`; crate 0.3.0 | BSD-2-Clause | Published 2026-09-21; MSRV 1.82; tagged active repository | Pure Rust, 12-package cone, no I/O; unbounded/tolerant public DCQL models require a private bounded facade and portable target proof | `spike` / `conditional-adopt` under ADR 0156 |
| IOTA [`identity`](https://github.com/iotaledger/identity/tree/7dd527087b96bf26ea97d486225eff8278c9a89c) | `7dd52708`; syntax release `v1.5.1@917b3815` | Apache-2.0 | [Beta v1.9.13](https://github.com/iotaledger/identity/releases/tag/v1.9.13-beta.1); workspace MSRV 1.65; host and WASM CI | Mature generic crates coexist with IOTA network/MoveVM and exact internal/Git coupling; ADR 0104 found the published syntax crate too broad and advisory-bearing for automated use | `oracle` portfolio / `reference-only` syntax fixture |
...
| Affinidi OID4VC releases, MSRV and dependency topology | [workspace](https://github.com/affinidi/affinidi-tdk-rs/tree/66120dd70d6919152923d00dad2eede8a7ec1ac3), [OID4VCI crate](https://crates.io/crates/affinidi-openid4vci/0.2.1), [OID4VP crate](https://crates.io/crates/affinidi-openid4vp/0.1.3) |
| SIROS DCQL release, source and public semantics | [crate](https://crates.io/crates/siros-dcql/0.3.0), [tagged source](https://github.com/sirosfoundation/siros-dc-matcher/tree/d4eeff53d24c9bf8e3fe50aecba2a554b2618961), [completed isolated evidence](../siros-dcql-spike/results.md) |
