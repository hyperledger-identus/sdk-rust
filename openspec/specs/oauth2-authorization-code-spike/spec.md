# oauth2-authorization-code-spike Specification

## Purpose

Preserve the reproducible, non-production decision boundary for evaluating
OAuth authorization-code and PKCE mechanics without admitting a general OAuth
client into Identus runtime or public API surfaces.
