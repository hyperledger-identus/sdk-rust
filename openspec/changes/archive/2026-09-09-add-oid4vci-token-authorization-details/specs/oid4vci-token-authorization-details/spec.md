# OID4VCI Token Response authorization details

## Purpose

Define a bounded typed state for credential Authorization Details returned in
an OpenID4VCI 1.0 Final successful Token Response.
