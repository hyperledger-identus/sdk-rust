...
if rg -q 'identity_did|identity-did|identity_core|identity-core|identity_jose|identity-jose' \
...
tree=$(cargo +1.98.1 tree --manifest-path "$fixture/Cargo.toml" --locked --edges normal,build)
