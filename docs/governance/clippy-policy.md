...
default workspace surface; the weekly/manual slow lane evaluates every Cargo
target with every feature enabled. Reproduce that complete surface locally on
