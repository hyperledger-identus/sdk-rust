...
- [x] 1.1 Create issue #111 under #7 / #20 / `IDR-023` with the exact base,
  standards, public contract, bounds, threats, dependency cone, and non-scope.
- [x] 1.2 Record immutable Oxid/Portal source revisions, path digests, license
  posture, behavior-only classification, and read-only checkout states.
- [x] 1.3 Specify transport states, URI/JSON validation, redaction,
  zeroization, reference least authority, compatibility, and rollback.
- [x] 1.4 Record ADR 0041 and complete the pre-implementation architecture,
  API, standards, security, and resource review with no unresolved blocker.
