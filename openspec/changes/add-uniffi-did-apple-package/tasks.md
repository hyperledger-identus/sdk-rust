...
- [x] 2.1 Add the static library artifact and exact Swift generator entry point without dependency or domain changes.
- [x] 2.2 Add an ephemeral deterministic XCFramework/SwiftPM assembly script and tracked package/test template.
- [x] 2.3 Prove arm64 device/Simulator variants, minimum platform, symbols, complete-tree equality and absence of absolute paths.
- [x] 2.4 Compile and execute the package behavior suite in an iOS Simulator through Xcode.
- [x] 2.5 Add the Apple proof to the weekly/manual slow macOS lane without changing fast PR CI.
