...
- [x] 4.3 Open an issue-linked PR, resolve hosted review findings, and make the
      change merge-ready for protected `develop` with every required check
      green; route non-blocking hardening to follow-up issue #301.
