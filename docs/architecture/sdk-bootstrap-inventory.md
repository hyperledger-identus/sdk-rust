...
| `identus-uniffi-did` | ABI-versioned DID/DID URL parsing with owned component records and closed stable-code errors | exact UniFFI 0.32 outer adapter; deterministic Swift/Kotlin host generation, macOS execution, local arm64 iOS device/Simulator XCFramework and iOS Simulator execution; no published mobile package or support claim | issues #226 and #228 under #222/#163 |
