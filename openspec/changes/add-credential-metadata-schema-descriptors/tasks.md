...
- [x] 1.1 Create issue #75 under #6 / `IDR-007` and record the exact base.
- [x] 1.2 Record W3C version, donor revisions/paths/digests/licenses,
  conceptual-adaptation classification, consumer states, and isolation.
- [x] 1.3 Specify scalar/path/collection/time invariants, privacy, performance,
  stable errors, compatibility, dependency cone, and deliberate non-scope.
- [x] 1.4 Record ADR 0025 and complete a pre-implementation semantic/API/
