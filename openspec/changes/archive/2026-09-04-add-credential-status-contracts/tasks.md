...
- [x] 1.1 Create issue #77 under #6 / `IDR-007` and #20 and record the exact
  base.
- [x] 1.2 Record W3C versions, donor revisions/paths/digests/licenses,
  conceptual-adaptation classification, consumer states, and isolation.
- [x] 1.3 Specify scalar/opaque/collection/freshness/query/evidence invariants,
  privacy, performance, stable errors, compatibility, and deliberate non-scope.
- [x] 1.4 Record ADR 0026 and complete a pre-implementation semantic/API/
  security/performance review with no unresolved blocker.
