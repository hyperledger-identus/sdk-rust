...
- [x] 2.1 Add positive response limits and bounded strict core parsing with
  RFC token, token-type, expiry, and scope validation.
- [x] 2.2 Add zeroizing partial response/token types, stable fieldless errors,
...
- [x] 3.1 Add positive, negative, grammar, bound, extension, and diagnostic
