...
- [x] 1.1 Create issue #73 under #6 / `IDR-009` and record the exact base.
- [x] 1.2 Record donor revisions, paths, digests, licenses, conceptual-adapt
  classification, consumer states, and explicit repository isolation.
- [x] 1.3 Specify taxonomy, reason grammar, invariants, derived outcomes,
  allocation/performance shape, errors, compatibility, and deliberate scope.
- [x] 1.4 Record ADR 0024 and complete pre-implementation semantic/API/security/
  performance review with no unresolved blocker.
