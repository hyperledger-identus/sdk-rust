...
| `identus-presentations` | bounded request/query/claim/challenge, request-validated candidate, and validated disclosure-plan contracts | no protocol wire, candidate lookup/ranking, selection or consent policy, proof execution, presentation artifact/receipt, lifecycle, storage, FFI, chain or product behavior | issues #79 and #81; later presentation slices remain experimental |
