...
can model their exact AST scope. V1 likewise recognizes only byte-contiguous
`#[` attributes; whitespace-separated openers remain production and cannot
seed module inheritance.
