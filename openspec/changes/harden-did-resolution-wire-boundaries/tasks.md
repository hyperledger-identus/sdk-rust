...
- [x] 1.1 Reconcile issue #41 with exact base, standards/test-suite revisions,
      hashes, donor receipts, compatibility, threat/resource policy, non-scope,
      and rollback
- [x] 1.2 Complete and strictly validate the OpenSpec delta, ADR 0017, and
