...
| `identus-uniffi-did` | ABI-versioned DID/DID URL parsing with owned component records and closed stable-code errors | exact UniFFI 0.32 outer adapter; deterministic Swift/Kotlin generation and macOS host runtime only; no mobile package or support claim | issue #226 under #222/#163 |
