...
| `identus-credentials` | bounded format identifier, opaque artifacts/envelope and canonical staged verification evidence | no serde/codecs, trust decisions, verifier execution, metadata/schema, status bindings or storage | issues #71 and #73; later credential/verification slices remain experimental |
