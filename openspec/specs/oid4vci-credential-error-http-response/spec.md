# oid4vci-credential-error-http-response Specification

## Purpose
TBD - created by archiving change add-oid4vci-credential-error-http-response. Update Purpose after archive.
## Requirements
