...
- [x] 1.1 Audit repository-local governance, workspace packages and read-only
  live GitHub state at exact base `1d890fd`; create #25 and protected follow-up
  #26, then reconcile parent #4 before implementation.
- [x] 1.2 Define and semantically review governance-evidence and corrected
  placeholder requirements with no unresolved blocker.
