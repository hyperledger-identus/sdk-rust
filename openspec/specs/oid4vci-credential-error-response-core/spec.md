# oid4vci-credential-error-response-core Specification

## Purpose
TBD - created by archiving change add-oid4vci-credential-error-response. Update Purpose after archive.
## Requirements
